...
public class MainScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("AFazer - Gerenciador de Tarefas");
        setMinimumSize(new java.awt.Dimension(800, 600));

        jPanelTitle.setBackground(new java.awt.Color(0, 152, 218));

        jLabelMainTitle.setFont(new java.awt.Font("Segoe UI", 1, 30)); // NOI18N
        jLabelMainTitle.setForeground(new java.awt.Color(255, 255, 255));
        jLabelMainTitle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tick.png"))); // NOI18N
        jLabelMainTitle.setText(" AFazer - Gerenciador de Tarefas");
        jLabelMainTitle.setMaximumSize(new java.awt.Dimension(515, 53));
        jLabelMainTitle.setPreferredSize(new java.awt.Dimension(515, 53));
        ...
        jPanelTitleLayout.setVerticalGroup(
            ...
            .addGroup(jPanelTitleLayout.createSequentialGroup()
                .addGap(25, 25, 25)
                .addComponent(jLabelMainTitle, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanelProjects.setPreferredSize(new java.awt.Dimension(4, 4));

        jLabelProjectsTitle.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        jLabelProjectsTitle.setForeground(new java.awt.Color(0, 152, 218));
        ...
        jLabelTasksTitle.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        jLabelTasksTitle.setForeground(new java.awt.Color(0, 152, 218));
        ...
        jListProjects.setSelectionBackground(new java.awt.Color(204, 204, 255));
        ...
        jPanelProjectListLayout.setVerticalGroup(
            ...
            .addGroup(jPanelProjectListLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPaneProjects, javax.swing.GroupLayout.PREFERRED_SIZE, 405, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabelEmptyListTitle.setForeground(new java.awt.Color(0, 152, 218));
        ...
        jPanelEmptyListLayout.setHorizontalGroup(
            ...
            .addComponent(jLabelEmptyListTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanelTasks, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanelProjects, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanelProjectList, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanelTaskList, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void jTableTasksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableTasksMouseClicked
        ...
        switch(columnIndex) {
            case 3:
                ...
                break;
            case 4:
                TaskUpdateDialogScreen taskUpdateDialogScreen = 
                        new TaskUpdateDialogScreen(this, rootPaneCheckingEnabled,
                        task);
                
                int projectIndexToUpdateTask = jListProjects.getSelectedIndex();
                Project projectToUpdateTask = (Project) projectsModel
                        .get(projectIndexToUpdateTask);
                
                taskUpdateDialogScreen.setProject(projectToUpdateTask);
                ...
                taskUpdateDialogScreen.addWindowListener(new WindowAdapter() {
                    @Override
                    public void windowClosed(WindowEvent e) {
                        loadTasks(projectToUpdateTask.getId());
                    }
                });
    ...
    public void decorateTableTask() {
        ...
        jTableTasks.getTableHeader().setBackground(new Color(0, 152, 218));
        jTableTasks.getTableHeader().setForeground(new Color(255, 255, 255));
        
        jTableTasks.getColumnModel().getColumn(2)
                .setCellRenderer(new util.DeadLineColumnCelRenderer());
        
        jTableTasks.getColumnModel().getColumn(4)
                .setCellRenderer(new util.ButtonColumnCellRenderer("editButton"));
        
        jTableTasks.getColumnModel().getColumn(5)
                .setCellRenderer(new util.ButtonColumnCellRenderer("deleteButton"));
